...
export default async function RoadmapPage({ params }: RoadmapPageProps) {
  ...
  const { appUser, profile, match, roadmaps } = await getRoadmapDetail(matchId);
          ...
          <Card>
            ...
            <CardContent className="grid gap-3 text-sm leading-6 text-muted-foreground">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge variant="outline">{roadmap.source || "deterministic-baseline"}</Badge>
              </div>
            </CardContent>
          </Card>
                ...
                <Card key={week.week}>
                  <CardHeader>
                    <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                      ...
                      <Badge variant={week.priority === "Critical" ? "secondary" : "outline"}>
                        {week.priority}
                      </Badge>
                    </div>
                  </CardHeader>
